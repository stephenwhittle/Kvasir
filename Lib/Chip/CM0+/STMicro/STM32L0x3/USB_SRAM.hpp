...
//Universal serial bus full-speed device      interface
    ...
    namespace UsbSramCntr{    ///<control register
        using Addr = Register::Address<0x40006040,0xffff0040,0x00000000,std::uint32_t>;
        ///Force USB Reset
    ...
    namespace UsbSramIstr{    ///<interrupt status register
        using Addr = Register::Address<0x40006044,0xffff0060,0x00000000,std::uint32_t>;
        ///Endpoint Identifier
    ...
    namespace UsbSramLpmcsr{    ///<LPM control and status          register
        using Addr = Register::Address<0x40006054,0xffffff04,0x00000000,std::uint32_t>;
        ///LPM support enable
    ...
    namespace UsbSramBcdr{    ///<Battery charging detector
        using Addr = Register::Address<0x40006058,0xffff7f00,0x00000000,std::uint32_t>;
