...
//General-purpose-timers
    ...
    namespace Tim2Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000008,0xffff0008,0x00000000,std::uint32_t>;
    ...
    namespace Tim2Or{    ///<TIM2 option register
        using Addr = Register::Address<0x40000050,0xffffffe0,0x00000000,std::uint32_t>;
        ///Timer2 ETR remap
