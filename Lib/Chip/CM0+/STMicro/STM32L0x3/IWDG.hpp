...
//Independent watchdog
    namespace IwdgKr{    ///<Key register
        using Addr = Register::Address<0x40003000,0xffff0000,0x00000000,std::uint32_t>;
    ...
    namespace IwdgPr{    ///<Prescaler register
        using Addr = Register::Address<0x40003004,0xfffffff8,0x00000000,std::uint32_t>;
        ///Prescaler divider
    ...
    namespace IwdgRlr{    ///<Reload register
        using Addr = Register::Address<0x40003008,0xfffff000,0x00000000,std::uint32_t>;
    ...
    namespace IwdgSr{    ///<Status register
        using Addr = Register::Address<0x4000300c,0xfffffff8,0x00000000,std::uint32_t>;
    ...
    namespace IwdgWinr{    ///<Window register
        using Addr = Register::Address<0x40003010,0xfffff000,0x00000000,std::uint32_t>;
