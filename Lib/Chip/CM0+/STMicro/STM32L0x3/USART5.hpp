...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart5Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40005000,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart5Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40005004,0x0000008f,0x00000000,std::uint32_t>;
    ...
    namespace Usart5Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40005008,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Usart5Brr{    ///<Baud rate register
        using Addr = Register::Address<0x4000500c,0xffff0000,0x00000000,std::uint32_t>;
        ///DIV_Mantissa
    ...
    namespace Usart5Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40005010,0xffff0000,0x00000000,std::uint32_t>;
        ///Guard time value
    ...
    namespace Usart5Rtor{    ///<Receiver timeout register
    ...
    namespace Usart5Rqr{    ///<Request register
        using Addr = Register::Address<0x40005018,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Usart5Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4000501c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Usart5Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40005020,0xffede4a0,0x00000000,std::uint32_t>;
    ...
    namespace Usart5Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40005024,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(8,0),Register::ReadWriteAccess,unsigned> rdr{}; 
    }
    namespace Usart5Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40005028,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
