...
//Basic-timers
    namespace Tim7Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001400,0xffffff70,0x00000000,std::uint32_t>;
    ...
    namespace Tim7Cr2{    ///<control register 2
        using Addr = Register::Address<0x40001404,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim7Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000140c,0xfffffefe,0x00000000,std::uint32_t>;
    ...
    namespace Tim7Sr{    ///<status register
        using Addr = Register::Address<0x40001410,0xfffffffe,0x00000000,std::uint32_t>;
    ...
    namespace Tim7Egr{    ///<event generation register
        using Addr = Register::Address<0x40001414,0xfffffffe,0x00000000,std::uint32_t>;
        ///Update generation
    ...
    namespace Tim7Cnt{    ///<counter
        using Addr = Register::Address<0x40001424,0xffff0000,0x00000000,std::uint32_t>;
        ///Low counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim7Psc{    ///<prescaler
        using Addr = Register::Address<0x40001428,0xffff0000,0x00000000,std::uint32_t>;
        ///Prescaler value
    ...
    namespace Tim7Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4000142c,0xffff0000,0x00000000,std::uint32_t>;
