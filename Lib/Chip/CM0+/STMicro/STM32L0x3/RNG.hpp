...
//Random number generator
    namespace RngCr{    ///<control register
        using Addr = Register::Address<0x40025000,0xfffffff3,0x00000000,std::uint32_t>;
        ///Interrupt enable
    ...
    namespace RngSr{    ///<status register
        using Addr = Register::Address<0x40025004,0xffffff98,0x00000000,std::uint32_t>;
    ...
    namespace RngDr{    ///<data register
        using Addr = Register::Address<0x40025008,0x00000000,0x00000000,std::uint32_t>;
        ///Random data
