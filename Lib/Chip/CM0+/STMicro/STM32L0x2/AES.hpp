...
//Advanced encryption standard hardware      accelerator
    namespace AesCr{    ///<control register
        using Addr = Register::Address<0x40026000,0xffffe000,0x00000000,std::uint32_t>;
    ...
    namespace AesSr{    ///<status register
        using Addr = Register::Address<0x40026004,0xfffffff8,0x00000000,std::uint32_t>;
        ///Write error flag
    ...
    namespace AesDinr{    ///<data input register
        using Addr = Register::Address<0x40026008,0x00000000,0x00000000,std::uint32_t>;
        ///Data Input Register.
    ...
    namespace AesDoutr{    ///<data output register
        using Addr = Register::Address<0x4002600c,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace AesKeyr0{    ///<key register 0
        using Addr = Register::Address<0x40026010,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace AesKeyr1{    ///<key register 1
        using Addr = Register::Address<0x40026014,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace AesIvr1{    ///<initialization vector register          1
        using Addr = Register::Address<0x40026024,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace AesIvr2{    ///<initialization vector register          2
        using Addr = Register::Address<0x40026028,0x00000000,0x00000000,std::uint32_t>;
    ...
    namespace AesIvr3{    ///<initialization vector register          3
        using Addr = Register::Address<0x4002602c,0x00000000,0x00000000,std::uint32_t>;
