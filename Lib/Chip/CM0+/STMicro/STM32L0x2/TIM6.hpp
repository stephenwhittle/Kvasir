...
//Basic-timers
    namespace Tim6Cr1{    ///<control register 1
        using Addr = Register::Address<0x40001000,0xffffff70,0x00000000,std::uint32_t>;
    ...
    namespace Tim6Cr2{    ///<control register 2
        using Addr = Register::Address<0x40001004,0xffffff8f,0x00000000,std::uint32_t>;
    ...
    namespace Tim6Dier{    ///<DMA/Interrupt enable register
        using Addr = Register::Address<0x4000100c,0xfffffefe,0x00000000,std::uint32_t>;
    ...
    namespace Tim6Sr{    ///<status register
        using Addr = Register::Address<0x40001010,0xfffffffe,0x00000000,std::uint32_t>;
    ...
    namespace Tim6Egr{    ///<event generation register
        using Addr = Register::Address<0x40001014,0xfffffffe,0x00000000,std::uint32_t>;
        ///Update generation
    ...
    namespace Tim6Cnt{    ///<counter
        using Addr = Register::Address<0x40001024,0xffff0000,0x00000000,std::uint32_t>;
        ///Low counter value
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> cnt{}; 
    }
    namespace Tim6Psc{    ///<prescaler
        using Addr = Register::Address<0x40001028,0xffff0000,0x00000000,std::uint32_t>;
        ///Prescaler value
    ...
    namespace Tim6Arr{    ///<auto-reload register
        using Addr = Register::Address<0x4000102c,0xffff0000,0x00000000,std::uint32_t>;
