...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40013800,0xe0000000,0x00000000,std::uint32_t>;
        ///Word length
    ...
    namespace Usart1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40013804,0x0000008f,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40013808,0xff810000,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Rtor{    ///<Receiver timeout register
        using Addr = Register::Address<0x40013814,0x00000000,0x00000000,std::uint32_t>;
        ///Block Length
    ...
    namespace Usart1Rqr{    ///<Request register
        using Addr = Register::Address<0x40013818,0xffffffe0,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Isr{    ///<Interrupt & status          register
        using Addr = Register::Address<0x4001381c,0xff802000,0x00000000,std::uint32_t>;
        ///REACK
    ...
    namespace Usart1Icr{    ///<Interrupt flag clear register
        using Addr = Register::Address<0x40013820,0xffede4a0,0x00000000,std::uint32_t>;
    ...
    namespace Usart1Rdr{    ///<Receive data register
        using Addr = Register::Address<0x40013824,0xfffffe00,0x00000000,std::uint32_t>;
        ///Receive data value
    ...
    namespace Usart1Tdr{    ///<Transmit data register
        using Addr = Register::Address<0x40013828,0xfffffe00,0x00000000,std::uint32_t>;
        ///Transmit data value
