...
//System window watchdog
    namespace WwdgCr{    ///<Control register
        using Addr = Register::Address<0x40002c00,0xffffff00,0x00000000,std::uint32_t>;
        ///Activation bit
    ...
    namespace WwdgCfr{    ///<Configuration register
        using Addr = Register::Address<0x40002c04,0xfffffc00,0x00000000,std::uint32_t>;
    ...
    namespace WwdgSr{    ///<Status register
        using Addr = Register::Address<0x40002c08,0xfffffffe,0x00000000,std::uint32_t>;
