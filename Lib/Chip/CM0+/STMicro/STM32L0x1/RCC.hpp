...
//Reset and clock control
    ...
    namespace RccCfgr{    ///<Clock configuration register
        using Addr = Register::Address<0x4002100c,0x88024000,0x00000000,std::uint32_t>;
    ...
    namespace RccCier{    ///<Clock interrupt enable          register
        using Addr = Register::Address<0x40021010,0xffffff40,0x00000000,std::uint32_t>;
    ...
    namespace RccCifr{    ///<Clock interrupt flag register
        using Addr = Register::Address<0x40021014,0xfffffe40,0x00000000,std::uint32_t>;
    ...
    namespace RccCicr{    ///<Clock interrupt clear register
        using Addr = Register::Address<0x40021018,0xfffffe40,0x00000000,std::uint32_t>;
    ...
    namespace RccAhbrstr{    ///<AHB peripheral reset register
        using Addr = Register::Address<0x40021020,0xfeffeefe,0x00000000,std::uint32_t>;
        ///Crypto module reset
    ...
    namespace RccApb2rstr{    ///<APB2 peripheral reset register
        ...
        ///TIM22 timer reset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(5,5),Register::ReadWriteAccess,unsigned> tim22rst{}; 
        ///TIM21 timer reset
    ...
    namespace RccApb1rstr{    ///<APB1 peripheral reset register
        using Addr = Register::Address<0x40021028,0x2781b7cc,0x00000000,std::uint32_t>;
        ...
        ///CRC reset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(27,27),Register::ReadWriteAccess,unsigned> crcrst{}; 
        ///I2C3 reset
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(30,30),Register::ReadWriteAccess,unsigned> i2c3{}; 
    }
    ...
    namespace RccAhbenr{    ///<AHB peripheral clock enable          register
        using Addr = Register::Address<0x40021030,0xfeffeefe,0x00000000,std::uint32_t>;
    ...
    namespace RccApb2enr{    ///<APB2 peripheral clock enable          register
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(7,7),Register::ReadWriteAccess,unsigned> fwen{}; 
    ...
    namespace RccApb1enr{    ///<APB1 peripheral clock enable          register
        using Addr = Register::Address<0x40021038,0x2f81b7ca,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> tim3en{}; 
    ...
    namespace RccAhbsmenr{    ///<AHB peripheral clock enable in sleep mode          register
        using Addr = Register::Address<0x40021040,0xfeffecfe,0x00000000,std::uint32_t>;
        ///Crypto clock enable during sleep mode              bit
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> cryptsmen{}; 
    ...
    namespace RccApb1smenr{    ///<APB1 peripheral clock enable in sleep mode          register
        using Addr = Register::Address<0x40021048,0x2781b7cc,0x00000000,std::uint32_t>;
    ...
    namespace RccCcipr{    ///<Clock configuration register
        using Addr = Register::Address<0x4002104c,0xfff0c3f0,0x00000000,std::uint32_t>;
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(16,16),Register::ReadWriteAccess,unsigned> i2c3sel0{}; 
        ///I2C3 clock source selection              bits
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(17,17),Register::ReadWriteAccess,unsigned> i2c3sel1{}; 
    }
    namespace RccCsr{    ///<Control and status register
        using Addr = Register::Address<0x40021050,0x007080f8,0x00000000,std::uint32_t>;
        ...
        ///Firewall reset flag
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(24,24),Register::ReadWriteAccess,unsigned> fwrstf{}; 
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(2,2),Register::ReadWriteAccess,unsigned> lsiiwdglp{}; 
        ///Remove reset flag
