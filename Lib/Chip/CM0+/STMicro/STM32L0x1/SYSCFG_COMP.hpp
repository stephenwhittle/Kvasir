...
//System configuration controller and COMP      register
    ...
    namespace SyscfgCompCfgr2{    ///<SYSCFG configuration register          2
        using Addr = Register::Address<0x40010004,0xffffc0f0,0x00000000,std::uint32_t>;
    ...
    namespace SyscfgCompComp1Ctrl{    ///<Comparator 1 control and status          register
    ...
    namespace SyscfgCompComp2Ctrl{    ///<Comparator 2 control and status          register
        using Addr = Register::Address<0x4001001c,0x3fff4886,0x00000000,std::uint32_t>;
