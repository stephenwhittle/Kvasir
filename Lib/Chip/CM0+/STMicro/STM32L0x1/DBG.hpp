...
namespace Kvasir {
//Debug support
    namespace DbgIdcode{    ///<MCU Device ID Code Register
    ...
    namespace DbgCr{    ///<Debug MCU Configuration          Register
    ...
    namespace DbgApb1Fz{    ///<APB Low Freeze Register
    ...
    namespace DbgApb2Fz{    ///<APB High Freeze Register
