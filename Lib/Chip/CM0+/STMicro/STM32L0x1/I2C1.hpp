...
//Inter-integrated circuit
    namespace I2c1Cr1{    ///<Control register 1
        using Addr = Register::Address<0x40005400,0xff002000,0x00000000,std::uint32_t>;
        ///Peripheral enable
    ...
    namespace I2c1Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40005404,0xf8000000,0x00000000,std::uint32_t>;
    ...
    namespace I2c1Oar1{    ///<Own address register 1
        using Addr = Register::Address<0x40005408,0xffff7800,0x00000000,std::uint32_t>;
        ///Interface address
    ...
    namespace I2c1Oar2{    ///<Own address register 2
        using Addr = Register::Address<0x4000540c,0xffff7801,0x00000000,std::uint32_t>;
        ///Interface address
    ...
    namespace I2c1Timingr{    ///<Timing register
        using Addr = Register::Address<0x40005410,0x0f000000,0x00000000,std::uint32_t>;
    ...
    namespace I2c1Timeoutr{    ///<Status register 1
        using Addr = Register::Address<0x40005414,0x70006000,0x00000000,std::uint32_t>;
        ///Bus timeout A
    ...
    namespace I2c1Isr{    ///<Interrupt and Status register
        using Addr = Register::Address<0x40005418,0xff004000,0x00000000,std::uint32_t>;
    ...
    namespace I2c1Icr{    ///<Interrupt clear register
        using Addr = Register::Address<0x4000541c,0xffffc0c7,0x00000000,std::uint32_t>;
        ///Alert flag clear
    ...
    namespace I2c1Pecr{    ///<PEC register
        using Addr = Register::Address<0x40005420,0xffffff00,0x00000000,std::uint32_t>;
    ...
    namespace I2c1Rxdr{    ///<Receive data register
        using Addr = Register::Address<0x40005424,0xffffff00,0x00000000,std::uint32_t>;
        ///8-bit receive data
    ...
    namespace I2c1Txdr{    ///<Transmit data register
        using Addr = Register::Address<0x40005428,0xffffff00,0x00000000,std::uint32_t>;
        ///8-bit transmit data
